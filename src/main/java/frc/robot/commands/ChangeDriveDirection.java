 ...
 *
 */
public class ChangeDriveDirection extends PathSection {
    ...
    public ChangeDriveDirection(double targetAngle, double innerSpeed, double outerSpeed, boolean arcRight, boolean is360) {
