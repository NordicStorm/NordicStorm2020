...
public class Shooter extends Subsystem {
    ...
    public Shooter() {
        ...
        table.addEntryListener("Ringlight", (local_table, key, entry, value, flags) -> {
           boolean on = value.getBoolean();
           lightEnabled = on;
           //System.out.println("changed value: " + value.getValue());
    ...
    public void periodic() {
        ...
        if(getFlywheelVelocityAbsoluteError()<rpmTolerance){
            timesRPMGood+=1;
        }else{
            timesRPMGood=0;
        ...
        if(autoHeadingEnable){
            ...
            if (Math.abs(turnVal) > 0.4) {
                turnVal = Math.copySign(0.4, turnVal);
            }
            if (Math.abs(turnVal) < 0.1 ) {
                turnVal = Math.copySign(0.1, turnVal);
            }
        ...
        //System.out.println("power:"+currentRequestedPivotPower);
    ...
    public boolean isReadyToShoot() {
        ...
        return timesRPMGood>=5 && timeLeftToMoveServo <= 30 && pivotIsAligned;
    }
    ...
    public double getVisionFrameID() {
        return visionNetTable.getEntry("frameID").getDouble(-1);
    }
