...
public class DriveForDistance extends Command {
     ...
     * @param rightSpeed
     */
    public DriveForDistance(double leftDistance, double rightDistance, double leftSpeed, double rightSpeed) {
        
        this.leftDistance=leftDistance;
        this.rightDistance=rightDistance;
        this.leftTargetSpeed=leftSpeed;
        this.rightTargetSpeed=rightSpeed;
...
/**
     ...
     * @param speed speed%. Between -1 and 1. Negative means backward
     */
    public DriveForDistance(double distance, double speed) {
        this((speed>0) ? -distance : distance, (speed>0) ? distance : -distance, -speed, speed);
    }
    
    /**
     * 
     * @param leftSpeed speed of the right wheel
     * @param rightSpeed speed of the left wheel
     * @param distance distance the ,. will travel, 913=1ft.
     * @return
     */
    /*public static DriveForDistance arc(double leftSpeed, double rightSpeed, double distance){
    ...
    protected void execute() {
        ...
        double leftSpeed=calcSpeedNeeded(leftPos, leftTargetPos, leftTargetSpeed);
        double rightSpeed=calcSpeedNeeded(rightPos, rightTargetPos, rightTargetSpeed);
        Robot.drivetrain.tankDriveDirect(leftSpeed, rightSpeed);
        if(getDistanceAway(leftPos, leftTargetPos, !(leftTargetSpeed>0))<=0
         && getDistanceAway(rightPos, rightTargetPos, rightTargetSpeed>0)<=0
