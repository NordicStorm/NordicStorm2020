...
public class MoveToDistanceFromTarget extends Command {
    ...
    public MoveToDistanceFromTarget(boolean handleIntake, boolean endWhenClose, double forwardMod) {
    ...
    public MoveToDistanceFromTarget(boolean handleIntake, boolean endWhenClose){
